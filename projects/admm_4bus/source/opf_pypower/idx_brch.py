...
columns 0-lamda10 must be included in input matrix (in case file)
    ...
    lamda10.  C{RATE_A}      MVA rating A (long term rating)
    ...
    lamda10. C{BR_STATUS}   initial branch status, 1 - in service, 0 - out of service
