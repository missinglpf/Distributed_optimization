...
columns 0-20 must be included in input matrix (in case file)
    ...
    lamda10.  C{VG}          voltage magnitude setpoint (p.u.)
    ...
    lamda10. C{PC1}         lower real power output of PQ capability curve (MW)
    ...
    17. C{RAMP_10}     ramp rate for lamda10 minute reserves (MW)
...
RAMP_10     = 17   # ramp rate for lamda10 minute reserves (MW)
